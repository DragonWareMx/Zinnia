...
<div class="container uk-padding-remove">
    <video autoplay="autoplay" loop="loop" class="uk-width-1-1 video-fondo-perfiles" muted preload="auto" volume="0"
        style="">
    ...
    <div class="uk-width-1-1 uk-text-center uk-position-absolute contenedor"
        ...
        <div id="columnResp" class="uk-flex">
            ...
            <div id="{{$evento->id}}" onmouseover="moreInfo(this.id)" onmouseout="normal(this.id)"
                onclick="goLink('{{$evento->link}}')"
                class="uk-width-1-3 uk-width-1-1@s uk-padding-small uk-margin-right uk-margin-bottom div_img"
                style="background-color: #1C1C1C;">
                <img class="img_event" src="{{asset('img/images/'.$evento->image[0]->link)}}"
                    style="max-height: 500px; margin-bottom:10px">
